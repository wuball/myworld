...
using Google.YouTube.MultiTenancy.HostDashboard;
...
namespace Google.YouTube.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(YouTubeDbContext context, SubscriptionPayment subscriptionPayment)
        {
