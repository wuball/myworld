...
$webMvcFolder = Join-Path $slnFolder "src/Google.YouTube.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Google.YouTube.Web.Public"
...
dotnet restore Google.YouTube.Web.sln
