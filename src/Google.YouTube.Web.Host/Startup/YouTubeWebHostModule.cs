...
using Google.YouTube.Web.Startup.ExternalLoginInfoProviders;
...
namespace Google.YouTube.Web.Startup
{
    ...
    public class YouTubeWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public YouTubeWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(YouTubeWebHostModule).GetAssembly());
        }
