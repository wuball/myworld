...
{
    public class SubscriptionPaymentRepository : YouTubeRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<YouTubeDbContext> dbContextProvider)
