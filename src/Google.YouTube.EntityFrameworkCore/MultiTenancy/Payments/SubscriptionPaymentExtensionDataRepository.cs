...
using Google.YouTube.EntityFrameworkCore.Repositories;

namespace Google.YouTube.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : YouTubeRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<YouTubeDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
