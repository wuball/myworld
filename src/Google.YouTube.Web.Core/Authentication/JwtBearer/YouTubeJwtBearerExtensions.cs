...
/// </summary>
public static class YouTubeJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, YouTubeAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
