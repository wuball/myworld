...
namespace Google.YouTube.Web.Authentication.JwtBearer
{
    public class YouTubeAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public YouTubeAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
