...
using Google.YouTube.Authentication.TwoFactor;
...
using Google.YouTube.Web.Authentication.JwtBearer;
using Google.YouTube.Web.Authentication.TwoFactor;
using Google.YouTube.Web.Models.TokenAuth;
...
namespace Google.YouTube.Web.Controllers
{
    ...
    public class TokenAuthController : YouTubeControllerBase
    {
