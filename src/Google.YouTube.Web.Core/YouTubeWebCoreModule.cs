...
using Google.YouTube.Web.Configuration;
using Google.YouTube.Web.DashboardCustomization;

namespace Google.YouTube.Web
{
    [DependsOn(
        typeof(YouTubeApplicationModule),
        typeof(YouTubeEntityFrameworkCoreModule),
    ...
    public class YouTubeWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public YouTubeWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(YouTubeApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(YouTubeWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(YouTubeWebCoreModule).Assembly);
        }
