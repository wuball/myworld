...
using Google.YouTube.DynamicEntityPropertyValues.Dto;
...
namespace Google.YouTube.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : YouTubeAppServiceBase, IDynamicEntityPropertyValueAppService
    {
