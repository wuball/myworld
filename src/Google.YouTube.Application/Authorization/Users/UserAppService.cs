...
using Google.YouTube.Authorization.Permissions;
...
using Google.YouTube.Authorization.Users.Exporting;
...
namespace Google.YouTube.Authorization.Users
{
    ...
    public class UserAppService : YouTubeAppServiceBase, IUserAppService
    {
