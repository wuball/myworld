...
{
    public class SessionAppService : YouTubeAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = YouTubeConsts.Currency,
                        CurrencySign = YouTubeConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = YouTubeConsts.AllowTenantsToChangeEmailSettings,
