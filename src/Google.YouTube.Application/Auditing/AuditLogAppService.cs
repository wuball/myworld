...
using Google.YouTube.Auditing.Exporting;
...
using EntityHistoryHelper = Google.YouTube.EntityHistory.EntityHistoryHelper;

namespace Google.YouTube.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : YouTubeAppServiceBase, IAuditLogAppService
    {
