...
using Google.YouTube.DemoUiComponents.Dto;

namespace Google.YouTube.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : YouTubeAppServiceBase, IDemoUiComponentsAppService
    {
