...
using Google.YouTube.Web.Public.Startup;
using Google.YouTube.Web.Session;

namespace Google.YouTube.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : YouTubeViewComponent
    {
