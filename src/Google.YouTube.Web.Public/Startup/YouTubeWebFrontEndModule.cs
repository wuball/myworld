...
namespace Google.YouTube.Web.Public.Startup
{
    [DependsOn(
        typeof(YouTubeWebCoreModule)
    )]
    public class YouTubeWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public YouTubeWebFrontEndModule(IWebHostEnvironment env, YouTubeEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(YouTubeWebFrontEndModule).GetAssembly());
        }
    }
}
