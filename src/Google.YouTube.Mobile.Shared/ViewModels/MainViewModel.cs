...
using Google.YouTube.Authorization.Users.Profile.Dto;
using Google.YouTube.Commands;
using Google.YouTube.Core.Threading;
using Google.YouTube.Models.NavigationMenu;
using Google.YouTube.Services.Navigation;
using Google.YouTube.ViewModels.Base;
using Plugin.Media;
...
using Google.YouTube.ApiClient;
using Google.YouTube.Controls;
using Google.YouTube.Dto;
using Google.YouTube.Extensions;
using Google.YouTube.Localization;
using Google.YouTube.UI;
using Google.YouTube.UI.Assets;
using Google.YouTube.Views;
using DependencyResolver = Google.YouTube.Core.Dependency.DependencyResolver;

namespace Google.YouTube.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "YouTube";
