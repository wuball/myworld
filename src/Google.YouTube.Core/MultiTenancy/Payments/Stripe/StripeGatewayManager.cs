...
{
    public class StripeGatewayManager : YouTubeServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "YouTube";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + YouTubeConsts.Currency;
        }
