...
namespace Google.YouTube.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : YouTubeServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Google.YouTube", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
