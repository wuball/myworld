...
namespace Google.YouTube.Web.Areas.App.Views.Shared.Themes.Theme9.Components.AppTheme9Brand
{
    public class AppTheme9BrandViewComponent : YouTubeViewComponent
    {
