...
namespace Google.YouTube.Web.Areas.App.Views.Shared.Themes.Theme5.Components.AppTheme5Brand
{
    public class AppTheme5BrandViewComponent : YouTubeViewComponent
    {
