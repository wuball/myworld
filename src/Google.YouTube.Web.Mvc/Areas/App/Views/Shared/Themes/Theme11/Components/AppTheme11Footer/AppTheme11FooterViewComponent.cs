...
namespace Google.YouTube.Web.Areas.App.Views.Shared.Themes.Theme11.Components.AppTheme11Footer
{
    public class AppTheme11FooterViewComponent : YouTubeViewComponent
    {
