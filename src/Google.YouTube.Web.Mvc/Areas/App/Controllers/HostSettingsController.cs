...
using Google.YouTube.Configuration.Host;
using Google.YouTube.Editions;
using Google.YouTube.Timing;
using Google.YouTube.Timing.Dto;
using Google.YouTube.Web.Areas.App.Models.HostSettings;
...
namespace Google.YouTube.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : YouTubeControllerBase
    {
