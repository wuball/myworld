...
using Google.YouTube.Identity;
using Google.YouTube.Schemas;
using Google.YouTube.Web.Chat.SignalR;
using Google.YouTube.Web.Common;
using Google.YouTube.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Google.YouTube.Web.IdentityServer;
using Google.YouTube.Web.Swagger;
using Stripe;
...
using Google.YouTube.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Google.YouTube.Web.Extensions;
using SecurityStampValidatorCallback = Google.YouTube.Identity.SecurityStampValidatorCallback;
...
namespace Google.YouTube.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<YouTubeWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseYouTubeForwardedHeaders();
            }
            else
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "YouTube API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Google.YouTube.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "YouTube API", Version = "v1"});
                ...
                var applicationXml = $"Google.YouTube.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Google.YouTube.Web.Core.xml";
