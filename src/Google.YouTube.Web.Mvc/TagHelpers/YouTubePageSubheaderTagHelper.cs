...
namespace Google.YouTube.Web.TagHelpers
{
    ...
    public class YouTubePageSubheaderTagHelper : TagHelper
    {
        ...
        public YouTubePageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
