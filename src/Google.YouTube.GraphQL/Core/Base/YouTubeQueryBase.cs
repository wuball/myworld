...
namespace Google.YouTube.Core.Base
{
    public abstract class YouTubeQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected YouTubeQueryBase(string fieldName,
